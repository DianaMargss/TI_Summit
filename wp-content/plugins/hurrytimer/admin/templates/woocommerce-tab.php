...
<div id="hurrytimer-tabcontent-woocommerce" class="hurrytimer-tabcontent">
    ...
    if (Helpers::isWcActive()): ?>
        <table class="form-table">
            ...
            <tr class="form-field hurrytimer-field-wc-products-selection-type">
                ...
                <td>
                    <select name="wc_products_selection_type"
                            id="hurrytimer-wc-products-selection-type">
            ...
            <tr class="form-field hurrytimer-field-wc-products-selection hidden">
                ...
                <td>
                    <select id="hurrytimer-wc-products-selection"
                            ...
                            class="hurrytimer-wc-products-selection"
                            multiple="multiple">
            ...
            <tr class="form-field hurrytimer-field-wc-position">
                ...
                <td>
                    <select name="wc_position" id="hurrytimer-wc-position">
                        <option
    ...
    <?php else: ?>
        <h3 style="text-align:center; margin-bottom:.2em"><?php _e("WooCommerce is not installed.", "hurrytimer") ?></h3>
        <p style="text-align:center; margin-top:0; color:#767676"><?php _e("Install WooCommerce to run the campaign on product page.", "hurrytimer") ?></p>
    <?php endif; ?>
</div>