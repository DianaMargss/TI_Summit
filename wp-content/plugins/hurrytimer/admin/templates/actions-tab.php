                ...
                <div class="hurrytimer-action-block-subfields hurrytimer-action-display-message-subfields hidden">
                    ...
                    <div class="hurrytimer-action-block-input">
                        <input type="text"
                               ...
                               value="<?php echo $action['message'] ?>"
                               class="hurrytimer-action-message"/>
                    </div>
                </div>
...
<div id="hurryt-upgrade-alert-actions-feat"
    ...
    <div class="hurryt-upgrade-alert-footer">
        ...
        <a href="http://hurrytimer.com/pricing?utm_source=plugin&utm_medium=actions&utm_campaign=learn_more" target="_blank" class="button">Learn more</a>
    </div>
