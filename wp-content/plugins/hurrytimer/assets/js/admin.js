...
(function ($) {
  ...
  $('.hurrytimer-datepicker').datetimepicker({
    controlType: 'select',
    dateFormat: 'yy-mm-dd',
    timeFormat: 'hh:mm TT',
    oneLine: true
  ...
  function handleMode(elementRef) {
    var evergreenModeSubfields = $('.hurryt-evergreen-mode-subfields');
    var regularModeSubfields = $('.hurryt-regular-mode-subfields');

    if (parseInt(elementRef.val()) === hurrytimer_ajax_object.mode.evergreen) {
      evergreenModeSubfields.removeClass('hidden');
      regularModeSubfields.addClass('hidden');
    } else {
      evergreenModeSubfields.addClass('hidden');
      regularModeSubfields.removeClass('hidden');
    }
  } // Handle mode.
